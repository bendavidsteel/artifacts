...
float getAudio(float cassini, float dist) {
...
void main(){
    ...
    float audio = getAudio(cassini, a);
	...
	line11[particleIdx].color.rgb = vec3(rms, 0., 1.);
	line11[particleIdx].color.a = 1.;

	line21[particleIdx].color.rgb = vec3(rms, 1., 0.);
	line21[particleIdx].color.a = 1.;

	// } else if (particleIdx < num_vertex) {
	// 	vec3 color1 = line12[particleIdx - audioSpeed].color.rgb;
	// 	line11[particleIdx].color.rgb = color1;
	// 	line11[particleIdx].color.a = 1.;

	// 	vec3 color2 = line22[particleIdx - audioSpeed].color.rgb;
	// 	line21[particleIdx].color.rgb = color2;
	// 	line21[particleIdx].color.a = 1.;
	// }
}